...
Public Class FuentesCondicional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fuentes.FuentesCondicional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFuentesCondicional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FuentesCondicional = New FuentesCondicional()
        rpt.Site = Me.Site
        Return rpt
    End Function
