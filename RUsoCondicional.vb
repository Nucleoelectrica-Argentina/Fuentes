...
Public Class RUsoCondicional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fuentes.RUsoCondicional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRUsoCondicional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RUsoCondicional = New RUsoCondicional()
        rpt.Site = Me.Site
        Return rpt
    End Function
